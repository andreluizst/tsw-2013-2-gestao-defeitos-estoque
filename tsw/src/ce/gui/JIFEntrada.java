...
public class JIFEntrada extends javax.swing.JInternalFrame implements IActionsGui {
     ...
     */
    private void selectObj(Entrada obj){
        for(int i=0;i<lista.size();i++){
            if (lista.get(i).getNumero() == obj.getNumero()){
    ...
    public void novo(){
        Entrada obj;
        PropEntrada propObj= new PropEntrada(null, true, null); 
    ...
    public void alterar(){
        Entrada obj;
        obj= lista.get(jTable1.getSelectedRow());
        PropEntrada propObj= new PropEntrada(null, true, obj); 
        propObj.setLocationRelativeTo(null);
        propObj.setVisible(true);
        obj= propObj.getProperties();
        if (obj != null){
    ...
    public void pesquisar(){
        ...
        try{
            ...
            e.setLote(jtxtLote.getText());
            if (jcbxFornecedores.getSelectedIndex() > 0){
                e.setFornecedor(lstForns.get(jcbxFornecedores.getSelectedIndex()));
            }
            if (jcbxProdutos.getSelectedIndex() > 0){
                e.setProduto(lstProds.get(jcbxProdutos.getSelectedIndex()));
            }
            tmpLista= f.pesquisarEntrada(e, jftfDtInicial.getText(), jftfDtFinal.getText());
            lista.clear();
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("Entrada");
        setPreferredSize(new java.awt.Dimension(893, 550));
        addInternalFrameListener(new javax.swing.event.InternalFrameListener() {
            public void internalFrameActivated(javax.swing.event.InternalFrameEvent evt) {
                JIFEntradaActivated(evt);
            }
            public void internalFrameClosed(javax.swing.event.InternalFrameEvent evt) {
            }
            public void internalFrameClosing(javax.swing.event.InternalFrameEvent evt) {
                JIFEntradaClosing(evt);
            }
        ...
        columnBinding.setColumnClass(ce.model.basica.Fornecedor.class);
        ...
        columnBinding.setColumnClass(ce.model.basica.Produto.class);
    ...
    private void JIFEntradaActivated(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_JIFEntradaActivated
        Main.atlzShellMenu(this);
    }//GEN-LAST:event_JIFEntradaActivated

    private void JIFEntradaClosing(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_JIFEntradaClosing
        Main.atlzShellMenu(null);
        Main.desregistrarJanela(this);
        dispose();
    }//GEN-LAST:event_JIFEntradaClosing
    ...
    private java.util.List<Entrada> lista;
